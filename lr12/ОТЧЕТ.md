...
На данном графики можно заметить, что в данной программе версия использующая CUDA покзывает значительно более эффективное решение по сравнению с OpenMP решением для более "квадратной" матрицы
